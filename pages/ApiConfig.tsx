...
const ApiConfig: React.FC = () => {
  ...
  const handleSync = async () => {
    ...
    try {
      ...
      // Note: This might block due to CORS if the provider doesn't allow it. 
      // If so, we'd need a backend proxy (Edge Function). for now assuming it works or using a proxy if provided.
    ...
    <div className="max-w-[1200px] mx-auto flex flex-col gap-6">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <button className="flex items-center gap-2 h-10 px-6 rounded-lg bg-primary hover:bg-primary/90 text-white text-sm font-bold shadow-lg shadow-primary/20 transition-all active:scale-95">
        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-6 flex flex-col gap-2">
            ...
            <div className="relative group">
              ...
              />
              <div className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[#92adc9] pointer-events-none">Aplicada a novos serviços</div>
            </div>
          </div>
          <div className="md:col-span-12 flex flex-col gap-2">
            ...
            <div className="relative group">
              ...
              />
              <button className="absolute right-3 top-1/2 -translate-y-1/2 text-[#92adc9] hover:text-white transition-colors cursor-pointer">
