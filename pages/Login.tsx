...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background-dark relative overflow-hidden">
      ...
      {/* Login Card */}
      <div className="relative z-10 w-full max-w-md space-y-8 bg-background-light dark:bg-background-dark p-8 rounded-2xl shadow-xl border border-border-dark m-4">
        <div className="text-center sm:text-left">
          <div className="flex justify-center sm:justify-start">
            <img src="/logo.png" alt="SocialPrime" className="h-20 w-auto mb-6" />
          </div>
        ...
        <form className="space-y-4" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex w-full justify-center rounded-lg bg-primary px-3 py-2.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-primary/90 transition-all duration-200 disabled:opacity-70 disabled:cursor-wait mt-6"
          >
