         ...
         <div className="flex flex-col gap-4">
            ...
            <div className="bg-card-dark rounded-xl border border-border-dark p-6 shadow-sm">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <button 
                        onClick={handlePay}
                        className="w-full mt-2 h-12 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-lg shadow-lg shadow-emerald-500/20 transition-all flex items-center justify-center gap-2"
                    >
