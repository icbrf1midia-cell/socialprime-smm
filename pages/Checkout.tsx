                  ...
                  <div className="w-full flex flex-col gap-3">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        readOnly
                        type="text"
                        value="00020126580014br.gov.bcb.pix0136123e4567-e89b-12d3-a456-426614174000520400005303986540549.905802BR5913Loja Exemplo6008Sao Paulo62070503***6304E2CA" // Ideally this should be dynamic
                      />
                      <button
                        onClick={() => {
                          navigator.clipboard.writeText("00020126580014br.gov.bcb.pix0136123e4567-e89b-12d3-a456-426614174000520400005303986540549.905802BR5913Loja Exemplo6008Sao Paulo62070503***6304E2CA");
